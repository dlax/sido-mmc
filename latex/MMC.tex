...
\hspace*{1pt}\psframebox[framearc=.5,fillcolor=white,framesep=2pt,linecolor=red,linewidth=1pt]{\includegraphics[width=1cm]{../icon/by2.eps}\includegraphics[width=1cm]{../icon/nc-eu2.eps}\includegraphics[width=1cm]{../icon/sa2.eps}}\\
