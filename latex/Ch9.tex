...
\begin{figure}[htp]
\centering
\subfloat[Élément triangulaire avec une fonction linéaire]{
\includegraphics{../images/T1_Ch09-02}
}\quad
\subfloat[Élément rectangulaire avec fonction bilinéaire]{
\includegraphics{../images/T1_Ch09-03}
}\quad
\subfloat[Élément triangulaire avec fonction quadratique]{
