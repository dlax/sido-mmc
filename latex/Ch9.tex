...
:a/ t 
n. s( 5~ .l
puisque sur S, ona \eqref{eq:Ch09-002}, et que, d'après 0) et \eqref{eq:Ch09-006}, est nul sur S.u,.. Finalement, on obtient donc 
.. 
\eqref{eq:Ch09-018} 1< (.u:..) 

Or le second terme est positif, puisque la matr~ce d' élasticité est défini~ positive (§ V.I.I). Ceci démontre \eqref{eq:Ch09-016}. cq f c 
...
.. .. 
cation de \eqref{eq:Ch09-016} montre que 
...
la fonctionnelle K -voir cours de Mathématiques -. Pour un problème de type II, la condition d'équilibre \eqref{eq:Ch09-019} apparaît naturellement, car sinon la 
