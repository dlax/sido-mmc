...
\subsection{Calcul du déplacehent}
\endinput
Pour terminer le calcul, il reste à.calculer le déplacement. A par­
tir de \eqref{eq:Ch07-048},\eqref{eq:Ch07-052} et \eqref{eq:Ch07-059}, le tenseur des déformations est donné par 
o 
-'f,!l, 
\label{eq:Ch07-069} ( = d o o o o 
